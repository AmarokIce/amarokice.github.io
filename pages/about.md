...
**名称/本名**：Amaruq·Illaujaq (阿玛鲁克·伊劳雅克)  
**种族**：北极狼  
**专业**：室内设计师  
**设计领域**：室内设计，平面设计，版图设计  
...
早安，这里是 Amaruq·Illaujaq，也可以称呼为雪狼，冰狼，或者缩写为 AmarokIce。是北地狼，喜欢凤梨，请给我凤梨。  
曾在百安居担任设计师助理，现无业游狼。热衷于游玩模拟狼生，喜欢狼谚语，喜欢睡觉，或者在宜家闲逛并打听流行设计。  
擅长使用 Java、Kotlin 与 DLang 完成日常编程任务，同时热衷于其他与 Jvm 相关的编程语言，例如 JRuby 与 Jython。  
关心数据与存储，喜欢轻量可携带的数据容器与设备。通常使用大脑编译代码，关行模块化设计。会在睡觉时梦里写码与构思设计。  
